...
revealView.onMenuOpening = function (visualization, args) {
    ...
    if (args.menuLocation === Reveal.RVMenuLocation.Visualization) {
       ... 
    }
};
```
...
Reveal.RVDashboard.loadDashboard("Project Management").then(dashboard => {
    const revealView = new Reveal.RevealView("#revealView");
    ...
    revealView.onMenuOpening = function (visualization, args) {
        ...
        if (args.menuLocation === Reveal.RVMenuLocation.Visualization) {
            //adding a new menu item to the "Tasks completed" visualization
            if(visualization.title === "Tasks Completed") {
                const menuItem = new Reveal.RVMenuItem("Custom Item on Tasks Completed", new Reveal.RVImage("https://i.pinimg.com/736x/03/c8/a2/03c8a2aff8be6bee9064eef9b5d72d66.jpg", "Icon"), () => {
                    alert('my action');
                })
...
Reveal.RVDashboard.loadDashboard("Project Management").then(dashboard => {
    ...
    revealView.onMenuOpening = function (visualization, args) {
        // to modify menu behavior on visualizations
        if (args.menuLocation === Reveal.RVMenuLocation.Visualization) {
            args.menuItems.push(new Reveal.RVMenuSeparatorItem());
            const menuItem1 = new Reveal.RVMenuItem("New section item 1", new Reveal.RVImage("https://i.pinimg.com/736x/03/c8/a2/03c8a2aff8be6bee9064eef9b5d72d66.jpg", "Icon"), () => {
                alert('action 1');
            })
            args.menuItems.push(menuItem1);
            const menuItem2 = new Reveal.RVMenuItem("New section item 2", new Reveal.RVImage("https://i.pinimg.com/736x/03/c8/a2/03c8a2aff8be6bee9064eef9b5d72d66.jpg", "Icon"), () => {
                alert('action 2');
            })
