...
| **italicFont**                                    | 斜体のフォント スタイルを設定します。                                                                                    |
| **boldItalicFont**                                | 太字斜体のフォント スタイルを設定します。                                                                                    |
...
各フォント プロパティにはフォント ファミリの名前を指定し、Reveal はそれを標準の太さとスタイルで描画します。フォント プロパティの解決方法と、すべてのスタイルに 1 つのフォント ファミリを使用する方法については、[テーマのフォント](theming-fonts.md)を参照してください。
