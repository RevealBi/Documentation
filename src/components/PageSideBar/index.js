...
export default function PageSideBar({ items, onItemClick }) {
    return (<aside className={clsx(ThemeClassNames.docs.docSidebarContainer, SidebarStyles.docSidebarContainer)}>
            ...
            if (item.type) {
                ...
                return (<li key={idx} className={clsx(ThemeClassNames.docs.docSidebarItemLink, ThemeClassNames.docs.docSidebarItemLinkLevel(1), 'menu__list-item')}>
