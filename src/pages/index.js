...
export default function Home() {
    ...
    return (<Layout title={`Get help with ${siteConfig.title}`} description="The Reveal embedded analytics platform allows you to simplify the way you integrate, manage and pay for data analytics.">
      <HomepageHeader />
      <main>
        <AiSpotlight />
        <HomepageFeatures />
