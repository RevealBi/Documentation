...
| Gemini 3.6 Flash | Google | 9 | 10 |
| Gemini 3.5 Flash Lite | Google | 10 | 10 |
...
| Gemma 4 12b | 10 | 8 | Ecellent results, a bit slow |
| Qwen3.5 9B | 8 | 9 | Great results, specially for a smaller model (ran with reasoning enabled) |
