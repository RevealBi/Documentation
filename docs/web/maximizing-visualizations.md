...
You can achieve this scenario by using the **maximizeVisualization** method in __Reveal.RevealView__, as shown below:
...
To take into account:
  - The __Reveal.RevealView__ object is set in \_window.revealView\</emphasis\> in order to use it later when **maximizeVisualization** property is set.
  ...
  - In this example, the buttons are hardcoded to match the visualizations in the sample dashboard, but you can also generate the list of buttons dynamically by iterating the list of
    visualizations in the dashboard. For further details see __Reveal.RVDashboard.visualizations__.
