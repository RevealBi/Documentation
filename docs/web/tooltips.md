...
Tooltips will follow the mouse cursor as it moves, and will become anchored once the mouse momentarily stops moving, making them available for clicking the actions contained in them.
