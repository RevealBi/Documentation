...
For the .NET platform, you need to install the `Reveal.Sdk.Cache.Redis` NuGet package:
...
Java and Node.js platforms do not require any additional package installation for Redis cache support.
