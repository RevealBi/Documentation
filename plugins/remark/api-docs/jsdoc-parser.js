const removeCommentSyntax = (comment) => {
    return comment
...
const parseCssProperties = (lines) => {
    const cssProperties = [];
    for (const line of lines) {
...
export const parseJsDocs = (comment) => {
