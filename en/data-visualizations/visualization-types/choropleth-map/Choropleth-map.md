...
6. Format the *Value* field to show percentage. Select the *Total Votes (%)* under *Value* > *Formatting* > *Type* > *Percent*. Find more about formatting fields in the [Field Settings](~/en/data-visualizations/fields/field-settings.md) topic.
