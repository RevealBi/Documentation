...
To use the Export as an image feature you will need to add a reference to [CefSharp.Wpf NuGet package (\>= 57.0.0)](~/en-us/developer/general/setup-configuration-desktop.md) to your project.
